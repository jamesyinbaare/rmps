      ...
      {balance && (
        <div className="grid gap-6 md:grid-cols-3 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold">{Number(balance.total_purchased || 0).toFixed(2)}</div>
              <p className="text-sm text-gray-600 mt-1">credits</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold">{Number(balance.total_used || 0).toFixed(2)}</div>
              <p className="text-sm text-gray-600 mt-1">credits</p>
            </CardContent>
          </Card>
        </div>
              ...
              {transactions.map((tx) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div
                      className={`font-bold ${
                        Number(tx.amount || 0) > 0 ? "text-green-600" : "text-red-600"
                      }`}
                    >
                    ...
                    <div className="text-sm text-gray-600">
                      Balance: {Number(tx.balance_after || 0).toFixed(2)}
                    </div>
                  </div>
                </div>
              ))}
