                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <ul className="text-sm text-blue-800 space-y-1.5 list-none pl-0">
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-blue-600 mt-0.5 shrink-0" />
                          <span><strong className="font-semibold">exam_type</strong> - Exam type. You can use codes (e.g., <code className="bg-blue-100 px-1 rounded text-xs">"cert2"</code>, <code className="bg-blue-100 px-1 rounded text-xs">"tech1"</code>) or full names. See <Link href="/api/dashboard/docs?tab=codes" className="text-blue-700 underline hover:text-blue-900 inline-flex items-center gap-1">Codes Reference <ExternalLink className="h-3 w-3" /></Link> for all codes.</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-blue-600 mt-0.5 shrink-0" />
                          <span><strong className="font-semibold">exam_series</strong> - Exam series. You can use codes (e.g., <code className="bg-blue-100 px-1 rounded text-xs">"mj"</code>, <code className="bg-blue-100 px-1 rounded text-xs">"nd"</code>) or full names ("MAY/JUNE", "NOV/DEC"). Only required for Certificate II Examinations.</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-blue-600 mt-0.5 shrink-0" />
                      ...
                      <div className="mt-3 pt-3 border-t border-blue-300">
                        <Link href="/api/dashboard/docs?tab=codes" className="text-sm text-blue-700 hover:text-blue-900 inline-flex items-center gap-2 font-medium">
                          <BookOpen className="h-4 w-4" />
                          View complete codes reference →
                        </Link>
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="w-full text-sm border-collapse">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="border border-gray-300 px-3 py-2 bg-white">
                            <div className="space-y-1">
                              <div className="font-mono text-xs text-purple-700">cert2</div>
                              <div className="text-xs text-gray-500">or "Certificate II Examinations"</div>
                            </div>
                          </td>
                          <td className="border border-gray-300 px-3 py-2 bg-white">
                            <div className="space-y-1">
                              <div className="font-mono text-xs text-purple-700">mj</div>
                              <div className="text-xs text-gray-500">or "MAY/JUNE"</div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="border border-gray-300 px-3 py-2 bg-white">
                            <div className="space-y-1">
                              <div className="font-mono text-xs text-purple-700">advance</div>
                              <div className="text-xs text-gray-500">or "Advance"</div>
                            </div>
                          </td>
                          <td className="border border-gray-300 px-3 py-2 bg-white">
                            <span className="text-xs text-gray-500">-</span>
                            <span className="text-xs text-gray-500 ml-1">(not required)</span>
                          </td>
                          <td className="border border-gray-300 px-3 py-2 bg-white">2024</td>
                        </tr>
                      </tbody>
