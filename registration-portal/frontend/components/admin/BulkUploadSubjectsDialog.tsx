...
export function BulkUploadSubjectsDialog({
  ...
  const handleDropZoneClick = () => {
    const fileInput = document.getElementById("subject-file-input") as HTMLInputElement;
    if (fileInput) {
      fileInput.click();
    }
  };
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an Excel or CSV file with subject data. The file should have columns: Code, Name, Subject Type
          </DialogDescription>
        </DialogHeader>
