...
import { uploadSchoolsBulk, downloadSchoolTemplate } from "@/lib/api";
import type { SchoolBulkUploadResponse, SchoolBulkUploadError } from "@/types/document";
...
export default function UploadSchoolsPage() {
  ...
  const [result, setResult] = useState<SchoolBulkUploadResponse | null>(null);
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      a.href = url;
      a.download = "school_upload_template.xlsx";
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await uploadSchoolsBulk(file);
      setResult(response);

      if (response.successful > 0) {
        toast.success(`Successfully uploaded ${response.successful} school(s)`);
      }
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to upload schools";
  ...
  return (
    <DashboardLayout title="Upload Schools">
      <div className="flex flex-1 flex-col overflow-hidden">
        <TopBar title="Upload Schools" />
          ...
          <div className="px-6 pt-6 space-y-6 max-w-4xl mx-auto">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        ...
                        <li><strong>School Type</strong> (optional) - "PUBLIC" or "PRIVATE"</li>
                        <li><strong>Programme Codes</strong> (optional) - Comma-separated programme codes (e.g., "PROG01,PROG02")</li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <table className="text-xs border-collapse">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="px-3 py-2 text-left border-r">Region</th>
                            <th className="px-3 py-2 text-left border-r">Zone</th>
                            <th className="px-3 py-2 text-left border-r">School Type</th>
                            <th className="px-3 py-2 text-left">Programme Codes</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="px-3 py-2 border-r font-mono">SCH001</td>
                            <td className="px-3 py-2 border-r">Example School 1</td>
                            <td className="px-3 py-2 border-r">Greater Accra Region</td>
                            <td className="px-3 py-2 border-r">A</td>
                            <td className="px-3 py-2 border-r">PUBLIC</td>
                            <td className="px-3 py-2">PROG01,PROG02</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-2 border-r font-mono">SCH002</td>
                            <td className="px-3 py-2 border-r">Example School 2</td>
                            <td className="px-3 py-2 border-r">Ashanti Region</td>
                            <td className="px-3 py-2 border-r">B</td>
                            <td className="px-3 py-2 border-r">PRIVATE</td>
                            <td className="px-3 py-2">PROG01</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                      ...
                      <li>School type must be either "PUBLIC" or "PRIVATE" (if provided)</li>
                      <li>Programme codes must exist in the system (invalid codes will be reported but school will still be created)</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Download the template or upload your school data file.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="max-h-60 overflow-y-auto border rounded-md">
                          <table className="w-full text-sm">
                            ...
                            <tbody>
                              {result.errors.map((error: SchoolBulkUploadError, idx: number) => (
