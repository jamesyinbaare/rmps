...
from app.routers import (
    ...
    admin_examiner_allowance_groups,
    admin_examiner_payout_overrides,
    admin_examiner_attendance,
    admin_examiner_attendance_sheets,
    admin_subject_marking_groups,
    admin_workforce_exercise_groups,
    admin_lunch_coupon,
...
app = FastAPI(title="Certificate Examination Resource Management System", lifespan=lifespan)
...
app.include_router(admin_cohort_examiner_portal_release.router)
...
app.include_router(admin_examiner_allowance_groups.router)
app.include_router(admin_examiner_payout_overrides.router)
...
app.include_router(admin_workforce_exercise_groups.router_script_checkers)
app.include_router(admin_workforce_exercise_groups.router_data_entry_clerks)
app.include_router(admin_workforce_appointment_letter_settings.router)
