...
export default function AdminScriptCheckerRatesPage() {
    ...
    <RoleGuard allowedRoles={["SUPER_ADMIN", "FINANCE_OFFICER"]} loginHref="/login/admin">
      <div className="space-y-3">
        <OfficialAccountsPageIntro
          description="Configure per-script rate, daily commute and lunch allowances, and withholding tax for BoG payout."
        />
        <WorkforceRatesPanel config={SCRIPT_CHECKER_CONFIG} exams={exams} formatExamLabel={formatWorkforceExamLabel} />
      </div>
    </RoleGuard>
  );
}
