...
export const ROSTER_COLUMN_TOGGLE_OPTIONS = [
  ...
  { id: "background_occupation_type", label: "Background type", defaultVisible: false },
  { id: "background_institution_name", label: "Institution", defaultVisible: false },
  { id: "background_teaching_subject", label: "Teaching subject", defaultVisible: false },
  { id: "background_industry", label: "Industry", defaultVisible: false },
  { id: "background_specialization", label: "Specialization", defaultVisible: false },
