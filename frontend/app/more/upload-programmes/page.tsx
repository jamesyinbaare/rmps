...
import type { ProgrammeBulkUploadResponse, ProgrammeBulkUploadError, ExamType } from "@/types/document";
import { Upload, CheckCircle2, XCircle, AlertCircle, ArrowLeft, FileText, Download } from "lucide-react";
import { toast } from "sonner";

export default function UploadProgrammesPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to upload programmes";
  ...
  return (
    <DashboardLayout title="Upload Programmes">
      <div className="flex flex-1 flex-col overflow-hidden">
        <TopBar title="Upload Programmes" />
          ...
          <div className="px-6 pt-6 space-y-6 max-w-4xl mx-auto">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Download the template or upload your programme data file.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
