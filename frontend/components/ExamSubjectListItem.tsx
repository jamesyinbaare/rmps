  ...
  return (
    <div className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
      ...
      <div className="mt-3 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 text-sm">
        {/* Max Scores */}
        <div>
          <label className="text-xs text-muted-foreground">Obj Max</label>
          {isEditing ? (
            <Input
              type="number"
              step="0.01"
        ...
        <div>
          <label className="text-xs text-muted-foreground">Essay Max</label>
          {isEditing ? (
            <Input
              type="number"
              step="0.01"
        ...
        <div>
          <label className="text-xs text-muted-foreground">Pract Max</label>
          {isEditing ? (
            <Input
              type="number"
              step="0.01"
        ...
        {/* Percentages */}
        <div>
          <label className="text-xs text-muted-foreground">Obj %</label>
          {isEditing ? (
            <Input
              type="number"
              step="0.01"
        ...
        <div>
          <label className="text-xs text-muted-foreground">Pract %</label>
          {isEditing ? (
            <Input
              type="number"
              step="0.01"
